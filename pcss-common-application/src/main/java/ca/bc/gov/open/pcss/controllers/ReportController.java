...
public class ReportController {
  ...
  public GetJustinAdobeReportResponse getJustinAdobeReport(
    ...
    inner.setFormNm(inner.getFormNm() != null ? inner.getFormNm().toUpperCase(Locale.ROOT) : "");
    inner.setPrintYn(inner.getPrintYn() != null ? inner.getPrintYn().toUpperCase(Locale.ROOT) : "");

    inner.setParam1(inner.getParam1() != null ? inner.getParam1().toUpperCase(Locale.ROOT) : "");
    inner.setParam2(inner.getParam2() != null ? inner.getParam2().toUpperCase(Locale.ROOT) : "");
    inner.setParam3(inner.getParam3() != null ? inner.getParam3().toUpperCase(Locale.ROOT) : "");
    inner.setParam4(inner.getParam4() != null ? inner.getParam4().toUpperCase(Locale.ROOT) : "");
    inner.setParam5(inner.getParam5() != null ? inner.getParam5().toUpperCase(Locale.ROOT) : "");
    inner.setParam6(inner.getParam6() != null ? inner.getParam6().toUpperCase(Locale.ROOT) : "");
    inner.setParam7(inner.getParam7() != null ? inner.getParam7().toUpperCase(Locale.ROOT) : "");
    inner.setParam8(inner.getParam8() != null ? inner.getParam8().toUpperCase(Locale.ROOT) : "");
    inner.setParam9(inner.getParam9() != null ? inner.getParam9().toUpperCase(Locale.ROOT) : "");
    inner.setParam10(inner.getParam10() != null ? inner.getParam10().toUpperCase(Locale.ROOT) : "");
    ...
    try {
      HttpEntity<Map<String, String>> resp =
          restTemplate.exchange(
              builder.toUriString(), HttpMethod.POST, body, new ParameterizedTypeReference<>() {});
      ...
      HttpEntity<byte[]> resp2 =
          restTemplate.exchange(
              adobe_url, HttpMethod.GET, new HttpEntity<>(new HttpHeaders()), byte[].class);
      ...
      log.error(
          objectMapper.writeValueAsString(
              new OrdsErrorLog(
                  "Error received from ORDS", "getJustinAdobeReport", ex.getMessage(), inner)));
  ...
  public GetJustinReportResponse getJustinReport(@RequestPayload @Valid GetJustinReport search)
    ...
    var inner =
        search.getGetJustinReportRequest() != null
                && search.getGetJustinReportRequest().getGetJustinReportRequest() != null
    ...
    try {
      ...
      String b64EncodedReport =
          resp.getBody() != null ? Base64Utils.encodeToString(resp.getBody().getBytes()) : "";
      ...
      log.error(
          objectMapper.writeValueAsString(
              new OrdsErrorLog(
                  "Error received from ORDS", "getJustinReport", ex.getMessage(), inner)));
      throw new ORDSException();
    }
  }
  ...
  public GetOperationReportResponse getOperationReport(@RequestPayload GetOperationReport search)
    ...
    var inner =
        search.getGetOperationReportRequest() != null
                && search.getGetOperationReportRequest().getGetOperationReportRequest() != null
    ...
    try {
      ...
      log.error(
          objectMapper.writeValueAsString(
              new OrdsErrorLog(
                  "Error received from ORDS", "getOperationReport", ex.getMessage(), inner)));
      throw new ORDSException();
    }
  }
  ...
  public GetOperationReportLovResponse getOperationReportLov(
    ...
    try {
      ...
      log.error(
          objectMapper.writeValueAsString(
              new OrdsErrorLog(
                  "Error received from ORDS", "getOperationReportLov", ex.getMessage(), inner)));
      throw new ORDSException();
    }
  }
}
